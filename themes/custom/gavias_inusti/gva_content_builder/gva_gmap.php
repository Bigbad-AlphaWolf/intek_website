...
if(!class_exists('element_gva_gmap')):
   class element_gva_gmap{
      ...
      ?>
         ...
         <script src="<?php print (base_path() . drupal_get_path('theme', 'gavias_inusti')) ?>/vendor/gmap3.js"></script>
         <script src="<?php print (base_path() . drupal_get_path('theme', 'gavias_inusti')) ?>/vendor/jquery.ui.map.min.js"></script>
